package com.sleep_tracker.components.csv;
...
public class EEGFileWriter {
    ...
    public void sendData(File dataCSV) {
        ...
        sendIntent.putExtra(Intent.EXTRA_STREAM, fileProvider.getUriForFile(this.context, "com.sleep_tracker.fileprovider", dataCSV));

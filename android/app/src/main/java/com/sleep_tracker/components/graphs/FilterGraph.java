...
import com.sleep_tracker.components.csv.EEGFileReader;
import com.sleep_tracker.components.csv.EEGFileWriter;
import com.sleep_tracker.components.signal.CircularBuffer;
...
public class FilterGraph extends FrameLayout {
    ...
    public void initView(Context context) {
        ...
        filterPlot.getGraph().getBackgroundPaint().setColor(Color.rgb(154, 223, 130));
